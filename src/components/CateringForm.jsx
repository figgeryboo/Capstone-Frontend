            ...
            <Card>
                <Card.Body>
                    <div className="d-grid gap-2">
                            ...
                            <>
                                ...
                                <Form>
                                    ...
                                    <Form.Group className="mb-4" controlId="contactInfo">
                                        ...
                                        <Form.Control type="tel" placeholder="1234567890" maxLength="10" required />
                                    </Form.Group>
                                </Form>
                            </>
                        )}
                            ...
                            <>
                                ...
                                <Form>
                                    ...
                                    <Form.Group className="mb-4" controlId="location">
                                        ...
                                        <Form.Control type="text" placeholder="Event Location Address" required />
                                    </Form.Group>

                                    <Form.Group className="mb-4" controlId="eventSize">
                                        <Form.Label>Event Size</Form.Label>
                                        <Form.Control type="number" placeholder="20" min="20" max="50" required />
                                    </Form.Group>
                                </Form>
                            </>
                        )}
                            ...
                            <>
                                ...
                                <Form>
                                    ...
                                    <Form.Group className="mb-4" controlId="comments">
                                        ...
                                        <Form.Control as="textarea" rows={3} maxLength={250} placeholder="Comments" />
                                    </Form.Group>
                                </Form>
                            </>
                        )}
                        ...
                        {currentStep === 6 && (
                            <>
                                <h2 className="text-center mb-2">Confirmation of Submission</h2>
                                <p className="text-center font-big">
                                    Thank you for submitting your request. Lorem ipsum dolor sit amet,
                        ...
                        {/* Navigation buttons */}
                        {currentStep !== 1 && (
                            <Button onClick={handlePrevStep} className="mx-2" variant="secondary">
                                Previous
                            </Button>
                        )}
                        {currentStep !== 6 ? (
                            <Button onClick={handleNextStep} className="mx-2" variant="primary">
                                Next
                            </Button>
                        ) : (
                            <Button onClick={submitCateringForm} className="mx-2" variant="success">
                                Submit Your Request
                            </Button>
                        )}
                    </div>
