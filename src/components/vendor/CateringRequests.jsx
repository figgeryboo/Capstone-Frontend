    ...
    >
      {/* {requests.length === 0 ? (
        <h3  style={{
		  ...
		  }}> No Current Requests. Check back again later </h3>
      ) : ( */}
        <div>
          <div
          ...
          >
            ...
            >
              <MuiAlert
                ...
                severity="info"
              >
                Pressing anywhere besides "Unconfirm" will officially confirm
                this request. If you confirmed accidentally, press "Unconfirm".
              </MuiAlert>
            </Snackbar>
          </div>
        </div>
